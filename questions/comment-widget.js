...
const s_stylePath = '/questions/comment-widget-dark.css'; 
const s_formId = '1FAIpQLSfunePvvLOf7gflN7vIV9MEamXSnOjlWSvTxJG-uJgrajgy8g';
const s_nameId = 'none';
const s_websiteId = 'none';
const s_textId = '74309347';
const s_pageId = '442959815';
const s_replyId = 'none';
const s_sheetId = '1Tcli7IZjagyiTN6LdPo4i6rmLeDm5wNXt9TFjUMTuOc';
...
const s_submitButtonLabel = 'ASK';
const s_loadingText = 'loading questions...';
const s_noCommentsText = 'no questions yet. this means something is not working right, so please message me! try visiting "/questions" without any index.html';
const s_closedCommentsText = 'questions are closed temporarily';
...
const v_formHtml = `
    ...
    <div id="c_nameWrapper" class="c-inputWrapper">
        ...
        <input class="c-input c-nameInput" name="entry.${s_nameId}" id="entry.${s_nameId}" type="text" maxlength="${s_maxLengthName}">
    </div>
...
function fixFrame() {
    ...
    location.href = "/questions/thanks.html" //redirects user after submission
}
